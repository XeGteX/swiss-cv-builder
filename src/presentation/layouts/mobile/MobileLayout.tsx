...
import { Edit2, Eye, Download, Settings } from 'lucide-react';
...
export const MobileLayout: React.FC = () => {
    ...
    const { setActiveTab: setEditorTab } = useUIStore();
    ...
    const handleSettingsClick = () => {
        // Open REAL settings on desktop editor
        setEditorTab('settings');
        // Switch to editor tab to show it
        setActiveTab('editor');
    };
    ...
    return (
        <div className="w-full flex flex-col overflow-hidden relative" style={{
            ...
            <div className="h-14 bg-white flex items-center justify-between px-4 shrink-0 z-20 pt-safe-top shadow-md">
                ...
                {/* REALISTIC ANIMATED GEAR - Opens REAL settings */}
                <motion.button
            ...
            {/* Main Content Area - NO WHITE BLOCKS */}
            ...
            {/* Bottom Navigation - CENTERED INDICATOR - Only Editor and Preview */}
