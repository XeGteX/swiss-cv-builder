...
export const ACTION_VERBS_FR = new Set([
    'géré', 'dirigé', 'créé', 'développé', 'conçu', 'implémenté', 'optimisé',
    'augmenté', 'diminué', 'amélioré', 'réduit', 'économisé', 'généré', 'lancé',
    'orchestré', 'piloté', 'ingénié', 'architecturé', 'revitalisé', 'transformé',
    'négocié', 'mentoré', 'supervisé', 'coordonné', 'exécuté', 'livré', 'réalisé',
    'administré', 'analysé', 'bâti', 'collaboré', 'conseillé', 'contrôlé', 'défini'
]);
...
export const WEAK_WORDS_FR = new Set([
    'aidé', 'assisté', 'travaillé', 'responsable de', 'tâches incluaient', 'essayé', 'tenté', 'participé à'
]);
